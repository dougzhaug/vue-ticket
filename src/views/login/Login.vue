...
<!--                <div class="weui-cell__bd">-->
<!--                    <input class="weui-input" v-model="password" key="password" type="password" placeholder="请输入密码"/>-->
<!--                </div>-->
<!--            </div>-->
        </div>
        ...
        methods:{
            ...
            login(){
                ...
                BindPhone(this.phone,this.captcha).then((response)=>{
                    let originRouterName = localStorage.originRouterName;
                    localStorage.removeItem('originRouterName');
                    this.$router.push({ name: originRouterName })
                });
            }
        }
    }
